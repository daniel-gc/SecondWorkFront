...
<!--                <div class="logo"></div>-->
                <div>
                    <img src="./assets/layout/images/logo_00.png" alt="Logo"
                         style="display: flex; margin-left: auto; margin-right: auto; width: 25%;">
                </div>
            </div>
...
export class AppTopbarComponent implements OnInit {
    ...
    constructor(public app: AppMainComponent, private tokenService: TokenService) {}
